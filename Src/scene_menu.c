...
static ALLEGRO_BITMAP* pacmanbg = NULL;
static ALLEGRO_SAMPLE_ID menuBGM;
static int gameTitleW ;
static int gameTitleH ;
static int pacmanbgW;
static int pacmanbgH;
...
static void init() {
	...
	pacmanbg = load_bitmap("Assets/pacmanbg.png");
	pacmanbgW = al_get_bitmap_width(pacmanbg);
	pacmanbgH = al_get_bitmap_height(pacmanbg);
	stop_bgm(menuBGM);
